...
const PassowrdGenerator = () => {
  ...
  return (
    <div className=" flex flex-wrap items-center justify-start w-full md:w-1/3 rounded-2xl my-8 p-4 bg-slate-600">
        ...
        <Button onClick={e=>{copyPassword(e)}} className=" bg-slate-900 rounded-none rounded-e-xl px-2 md:px-4 py-2 w-1/5 text-lg md:text-xl ">{passwordCopied?"Copied!!": " Copy"}</Button>
        </div>
